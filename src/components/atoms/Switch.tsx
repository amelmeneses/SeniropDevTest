...
// Props for the toggle switch: controlled via checked + onCheckedChange.
...
// Accessible toggle switch built with a button and role="switch".
// The thumb slides left/right via translate based on the checked state.
