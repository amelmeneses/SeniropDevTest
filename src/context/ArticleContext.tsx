...
const INITIAL_DATA: Article[] = [
    ...
    },
    {
        ...
        body: 'Great news for fresh food lovers: the Local Farmers’ Market is expanding its hours!',
...
export const ArticleProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    return (
        <ArticleContext.Provider value={{ articles, addArticle, updateArticle, deleteArticle, togglePublish }}>
            {children}
